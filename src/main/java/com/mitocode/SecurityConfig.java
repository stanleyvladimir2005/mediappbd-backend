...
import com.mitocode.security.CustomUserDetailsService;
import com.mitocode.security.JwtAuthenticationEntryPoint;
import com.mitocode.security.JwtAuthenticationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
        ...
        .antMatchers("/v1/tokens/**" ).permitAll()
        .antMatchers("/v1/consultaexamenes/**" ).authenticated()
